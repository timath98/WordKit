public struct WordKit {
    public private(set) var text = "Hello, World!"

    public init() {
    }
    
    public static func generateWord() -> String {
        let randomCategory = fiveLettersWords.randomElement()
        let randomWord = randomCategory?.randomElement()
